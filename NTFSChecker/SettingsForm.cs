...
public partial class SettingsForm : Form
{
    ...
    public SettingsForm(ILogger<MainForm> logger)
    {
        ...
        bool.TryParse(ConfigurationManager.AppSettings["IgnoreUndefined"], out bool ignoreUndef);
    ...
    private void BtnOK_Click(object sender, EventArgs e)
    {
        ...
        MessageBox.Show("Настройки цветов изменены");
    ...
    private void BtnDomainOk_Click(object sender, EventArgs e)
    {
        ...
        MessageBox.Show("Настройки домена изменены");
